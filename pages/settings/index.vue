  ...
  <UDashboardPanelContent class="pb-24">
    ...
    <UForm :state="state" :validate="validate" :validate-on="['submit']" @submit="onSubmit">
      <UDashboardSection title="个人信息" description="这些信息将被公开显示，因此请谨慎填写。">
        ...
        <UFormGroup name="avatar" label="头像" class="grid grid-cols-2 gap-2" help="JPG、GIF 或 PNG。最大 1MB。"
    ...
    <UDashboardSection title="账户"
                       description="不想再使用我们的服务？您可以在此删除您的账户。此操作不可逆转。与此账户相关的所有信息将被永久删除。">
      <div>
